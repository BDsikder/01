...
// ================================================================
// Firebase Config — localStorage ONLY (hardcoded default removed)
// ================================================================
function getFirebaseConfig() {
  ...
  return null; // config নেই — প্রথমবার setup দরকার
}

// database, auth, messaging শুরুতে undefined — init-এর পরে সেট হবে
...
// প্রথমবার চালানোর সময় বিশেষ setup modal
function _showFirstRunSetup() {
  const modal = document.getElementById('firebaseConfigModal');
  if (!modal) return;
  modal.style.display = 'flex';
  const h3 = modal.querySelector('h3');
  if (h3) h3.innerHTML = '<i class="fas fa-fire" style="margin-right:8px;color:#ff8c00;"></i>প্রথমবার সেটআপ — Firebase কনফিগ দিন';
  const hint = modal.querySelector('.firebase-config-hint');
  if (hint) hint.innerHTML =
    '<i class="fas fa-info-circle" style="color:#00d4ff;"></i> আপনার Firebase Console থেকে config কপি করে পেস্ট করুন।<br>' +
    '<i class="fas fa-lock" style="color:#00ff9d;"></i> একবার সেভ হলে ভবিষ্যতে আর লাগবে না।<br>' +
    '<i class="fas fa-exclamation-triangle" style="color:#ffb700;"></i> সেভের পর পেজ রিলোড হবে।';
  ...
  if (cancelBtn) {
    ...
    cancelBtn.title = 'প্রথমবার সেটআপে বাতিল করা যাবে না';
  }
}
...
// auth null guard: config না থাকলে auth undefined হবে
if (auth) {
...
function openFirebaseConfigModal() {
    ...
    // বর্তমান databaseURL দেখাও (null-safe)
    ...
    if (dbEl) dbEl.innerText = currentCfg
        ? (currentCfg.databaseURL || currentCfg.projectId || 'অজানা')
        : 'সেট করা হয়নি';
    // প্রথমবার setup: Cancel বাতিল রাখো
